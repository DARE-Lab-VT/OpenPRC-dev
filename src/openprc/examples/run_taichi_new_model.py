...
if __name__ == "__main__":
    ...
    C_VALS = np.linspace(0.0, 0.80, M_LEVELS)
    # M_LEVELS = 2
    # K_VALS = [0.0, 222.15]
    # C_VALS = [0.0, 0.8]
    ...
    for epoch in range(EPOCHS):
        ...
        print(f"Epoch {epoch+1:03d} | Avg MSE: {loss.item():.5f} | IPC: {total_capacity:.2f} | Max MSE: {mse_per_task.max().item():.5f}")
