...
# --- Configuration ---
TRIAL_NAME = "Taichi_IID_Memory_Opt_30Hz_k100"
ROWS, COLS = 4, 4
...
class ReservoirOptimizationFunction(torch.autograd.Function):
    @staticmethod
    def forward(ctx, pos_tensor, rho_tensor, res, u_sim, v_sim, downsample):
    ...
    def backward(ctx, grad_outputs_30Hz):
        ...
        return grad_pos, res.rho.grad.to_torch(), None, None, None, None
...
if __name__ == "__main__":
    ...
    res_opt = DifferentiableReservoir(config, dt_sim, len(u_sim))
    ...
    optimizer = torch.optim.Adam([rho_param], lr=0.01)
    ...
    for epoch in range(EPOCHS):
        ...
        X_30Hz = ReservoirOptimizationFunction.apply(pos_param, rho_param, res_opt, u_sim, v_sim, DOWNSAMPLE)
