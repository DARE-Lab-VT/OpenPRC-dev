...
HINGE_STIFFNESS = 0.1
HINGE_STIFFNESS_OOP = 0.0005 #was 0.0001
...
RUN = f"sim2real/topo{TOPOLOGY_NO}_amp{REAL_AMP_SCALE}_pretension{int(PRETENSION*100)}_OOP{HINGE_STIFFNESS_OOP}"
